/**
 * MotivationDetailScreen — migrated to Fluent UI.
 *
 * Structurally the sibling of SermonDetailScreen: same hero, action tiles and
 * bottom bar, with a "Motivation" badge in place of the content-type pill.
 */
...
> = {
  video: { icon: Video24Filled, label: 'Video', primaryAction: 'Watch' },
  audio: { icon: Headphones24Filled, label: 'Audio', primaryAction: 'Listen' },
  reading: { icon: BookOpen24Filled, label: 'Reading', primaryAction: 'Read' },
};
      ...
      >
        ...
        <View style={styles.hero}>
          ...
          <View style={styles.heroPills}>
            <View style={[styles.heroPill, { backgroundColor: colors.brandBackground as string }]}>
              <Flash16Filled color="#FFFFFF" width={12} height={12} />
